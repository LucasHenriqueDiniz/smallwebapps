...
export const apps: AppDefinition[] = [
  ...
  },
  {
    ...
    layoutWidth: "lg",
    implemented: true,
    shortDescription: "Generate random UUIDs (version 1, 3, 4, 5) or GUIDs instantly. Create unique identifiers for databases, APIs, and distributed systems locally without server calls.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Compare two pieces of text or code side-by-side. Highlight additions, deletions, and changes for code review, text comparison, and version control workflows.",
  ...
  },
  {
    ...
    layout: "intake",
    implemented: true,
    shortDescription: "View EXIF metadata from images including camera info, GPS location, timestamps, and technical specifications. Extract all metadata locally without uploads.",
  ...
  },
  {
    ...
    layout: "intake",
    implemented: true,
    shortDescription: "Convert files or text to hexadecimal dump format. View binary data as hex codes with ASCII preview. Useful for debugging, data inspection, and low-level analysis.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Extract comprehensive metadata from images (EXIF, IPTC, XMP). View file info, camera settings, location data, and timestamps locally.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Flatten nested JSON objects into a single level with dot-notation keys. Convert complex nested structures into simple key-value pairs.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Convert JSON objects into readable XML markup with proper indentation and formatting. Handle nested structures, arrays, and mixed data types. Useful for API integration, data transformation, and format conversion.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Preview Markdown as formatted HTML in real-time. Write and preview Markdown syntax instantly to see how it renders without external tools.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Format numbers with thousands separators, decimal places, currency symbols, and notation options. Convert between number formats for different use cases.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Generate Open Graph meta tags for social media sharing. Create proper OG tags for URLs to control how content appears on Facebook, Twitter, LinkedIn.",
  ...
  },
  {
    ...
    layout: "intake",
    implemented: true,
    shortDescription: "Extract text from images with OCR that runs entirely in your browser.",
    longDescription:
    ...
    appUrl: "/apps/image-to-text/",
    landingUrl: "/apps/image-to-text/",
    tags: ["ocr", "image to text", "extract text", "tesseract", "local", "privacy"],
    features: [
      "Runs entirely in your browser — the image is never uploaded to a server",
      "Supports 12 recognition languages including English, Portuguese, and Spanish",
      "Shows live progress and returns editable text you can copy or download as .txt",
      "Free to use with no account, watermark, or page limits",
    ],
    faq: [
      { question: "Is Image to Text free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my image?", answer: "No. OCR runs locally in the browser tab using WebAssembly. The image file is never sent to a server." },
      { question: "What kind of images work best?", answer: "Sharp, well-lit images of printed text — screenshots, scanned documents, and clean photos. Handwriting and stylized fonts are much less reliable." },
    ],
    faqExpanded: [
      { question: "Is Image to Text free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my image?", answer: "No. Recognition is done by the Tesseract OCR engine compiled to WebAssembly, running inside your browser tab. Your image never leaves your device — only the engine and language data are downloaded, once, and then cached." },
      { question: "Why does the first run take longer?", answer: "On first use the browser downloads the OCR engine and the language data for the language you picked (a few megabytes). Subsequent runs reuse the cached files and start much faster." },
      { question: "Which languages are supported?", answer: "English, Portuguese, Spanish, French, German, Italian, Dutch, Polish, Turkish, Russian, Japanese, and Simplified Chinese. Choose the language that matches the text in the image — running English OCR on Portuguese text will produce many errors." },
      { question: "Can it read handwriting?", answer: "Not reliably. Tesseract is designed for printed text. Neat block handwriting occasionally works, but cursive or informal handwriting usually produces garbled output." },
      { question: "Why is my result full of mistakes?", answer: "Common causes: the wrong language selected, a blurry or low-resolution image, skewed or rotated text, low contrast, or decorative fonts. Try a tighter crop around the text, a higher-resolution capture, and double-check the language setting." },
      { question: "Can I edit the result before copying it?", answer: "Yes — the extracted text appears in an editable text area, so you can fix recognition mistakes before using 'Copy text' or 'Download .txt'." },
    ...
    content: {
      ...
      howToUse: [
        ...
        "Wait while the OCR engine loads (first run only) and recognition runs — a progress bar shows the status.",
        "Review the extracted text, fix any recognition mistakes directly in the text area, then copy it or download it as a .txt file.",
      ],
      useCases: [
  ...
  {
    slug: "pdf-ocr",
    name: "PDF OCR - Scanned PDF to Text",
    category: "PDF Tools",
    status: "live",
    mode: "embedded",
    layout: "intake",
    implemented: true,
    shortDescription: "Extract text from scanned PDFs with OCR that runs entirely in your browser.",
    longDescription:
    ...
    appUrl: "/apps/pdf-ocr/",
    landingUrl: "/apps/pdf-ocr/",
    tags: ["pdf ocr", "scanned pdf", "pdf to text", "ocr", "tesseract", "local", "privacy"],
    features: [
      "Runs entirely in your browser — the PDF is never uploaded to a server",
      "Handles scanned and image-only PDFs that normal text extraction cannot read",
      "Per-page progress with page markers in the output, up to 50 pages per run",
      "Editable result you can copy or download as .txt, in 12 recognition languages",
    ],
    faq: [
      { question: "Is PDF OCR free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my PDF?", answer: "No. Pages are rendered and recognized locally in the browser tab. The file is never sent to a server." },
      { question: "How is this different from the PDF Text Extractor?", answer: "The PDF Text Extractor reads the text layer embedded in digital PDFs. PDF OCR recognizes text from the page images, which is what you need for scans and photographed documents." },
    ],
    faqExpanded: [
      { question: "Is PDF OCR free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my PDF?", answer: "No. Each page is rendered to an image and recognized by the Tesseract OCR engine compiled to WebAssembly, all inside your browser tab. Only the engine and language data are downloaded, once, and then cached." },
      { question: "How is this different from the PDF Text Extractor?", answer: "The PDF Text Extractor reads the text layer embedded in digitally created PDFs — fast and exact. Scanned PDFs have no text layer, only page images, so extraction returns nothing. PDF OCR recognizes the text from those images instead. If you're not sure which you have, try the extractor first; if it comes back empty, your PDF is a scan." },
      { question: "How many pages can it handle?", answer: "Up to 50 pages per run, to keep memory use reasonable. For longer documents, split the PDF first (the PDF Split tool on this site works) and run each part." },
      { question: "Why is it slow on my document?", answer: "OCR is computationally heavy: each page is rendered at high resolution and analyzed pixel by pixel on your own device. A few seconds per page is normal; older devices take longer." },
      { question: "Can it handle a password-protected PDF?", answer: "No. Password-protected and encrypted PDFs cannot be opened. Remove the password first with a PDF tool that knows the password." },
      { question: "Why is my result garbled or full of mistakes?", answer: "Usual causes: the wrong recognition language selected, a faint or skewed scan, handwriting (not supported), or complex multi-column layouts. A clean, straight, 300-DPI-equivalent scan in the selected language gives the best results." },
    ...
    content: {
      ...
      howToUse: [
        ...
        "Watch per-page progress as each page is rendered and recognized — a few seconds per page is normal.",
        "Review the extracted text (pages are separated by '--- Page N ---' markers), fix any mistakes, then copy it or download it as a .txt file.",
      ],
      useCases: [
  ...
  {
    slug: "searchable-pdf",
    name: "Searchable PDF Converter (OCR)",
    category: "PDF Tools",
    status: "live",
    mode: "embedded",
    layout: "intake",
    implemented: true,
    shortDescription: "Make a scanned PDF selectable and searchable by adding an invisible OCR text layer.",
    longDescription:
    ...
    appUrl: "/apps/searchable-pdf/",
    landingUrl: "/apps/searchable-pdf/",
    tags: ["searchable pdf", "ocr pdf", "selectable text", "scanned pdf", "text layer", "local", "privacy"],
    features: [
      "Returns the same PDF with an invisible, selectable text layer over each scanned page",
      "Search the result with Ctrl/Cmd+F and copy text directly from the pages",
      "Runs entirely in your browser — the PDF is never uploaded to a server",
      "Supports 7 Latin-alphabet languages including English, Portuguese, and Spanish",
    ],
    faq: [
      { question: "Is the Searchable PDF Converter free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my PDF?", answer: "No. Recognition and PDF editing happen locally in the browser tab. The file is never sent to a server." },
      { question: "How is this different from the PDF OCR tool?", answer: "PDF OCR gives you the extracted text as plain text. This tool puts the recognized text back inside the PDF as an invisible layer, so the document itself becomes selectable and searchable." },
    ],
    faqExpanded: [
      { question: "Is the Searchable PDF Converter free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my PDF?", answer: "No. Pages are rendered, recognized by the Tesseract OCR engine compiled to WebAssembly, and rewritten with pdf-lib — all inside your browser tab. Your document never leaves your device." },
      { question: "How is this different from the PDF OCR tool?", answer: "PDF OCR extracts the text out of the document as a .txt result. This tool writes the recognized words back into the PDF, invisibly, at the position where they appear on the scan — so the visible document is unchanged but you can select, copy, and Ctrl+F it like a digital PDF." },
      { question: "Will the PDF look different afterwards?", answer: "No. The scanned page images are untouched; the text layer is drawn with zero opacity on top of them. Only the file size grows slightly." },
      { question: "Why is text selection slightly offset or imperfect?", answer: "The invisible words are placed using the OCR engine's bounding boxes, which approximate — not exactly match — the printed glyphs. Selection and search work well, but highlights may not align pixel-perfectly with the scan." },
      { question: "Why does it support fewer languages than the other OCR tools?", answer: "The invisible layer uses a standard PDF font limited to the Latin-1 character set. Languages that need other scripts or letters outside that set (Russian, Japanese, Chinese, Polish, Turkish) can't be encoded reliably, so they are not offered here — use the PDF OCR tool to extract their text instead." },
      { question: "Does it work on a PDF that already has selectable text?", answer: "It will add a second OCR layer on top, which usually duplicates text in searches. For digital PDFs there's nothing to gain — this tool is for scans and image-only PDFs." },
    ...
    content: {
      ...
      howToUse: [
        "Select the language the document is written in — this strongly affects accuracy.",
        "Drop a scanned PDF onto the drop zone, or click it to browse.",
        "Watch per-page progress as each page is recognized and its invisible text layer is written.",
        "Download the resulting '-searchable.pdf' file, open it, and try selecting text or searching with Ctrl/Cmd+F.",
      ],
      useCases: [
  ...
  },
  {
    ...
    layout: "intake",
    implemented: true,
    shortDescription: "Extract text from JPG photos and images with in-browser OCR.",
    longDescription:
    ...
    appUrl: "/apps/jpg-to-text/",
    landingUrl: "/apps/jpg-to-text/",
    tags: ["jpg to text", "jpeg ocr", "photo to text", "ocr", "local", "privacy"],
    features: [
      "Runs entirely in your browser — the JPG is never uploaded to a server",
      "Works with photos of documents, signs, labels, and printed pages",
      "Supports 12 recognition languages including English, Portuguese, and Spanish",
      "Editable result you can copy or download as .txt",
    ],
    faq: [
      { question: "Is JPG to Text free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my photo?", answer: "No. OCR runs locally in the browser tab using WebAssembly. The JPG file is never sent to a server." },
      { question: "What kind of JPGs work best?", answer: "Straight-on, in-focus photos of printed text with even lighting. Strong angles, blur, glare, and handwriting significantly reduce accuracy." },
    ],
    faqExpanded: [
      { question: "Is JPG to Text free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my photo?", answer: "No. Recognition is done by the Tesseract OCR engine compiled to WebAssembly, running inside your browser tab. Your photo never leaves your device." },
      { question: "Can it read text from a photo taken with my phone?", answer: "Often, yes — if the photo is straight-on, in focus, and evenly lit. Retake the photo square to the page, in good light, if the first result is poor." },
      { question: "JPG or PNG — does the format matter for OCR?", answer: "Slightly. JPG compression can blur letter edges at low quality settings, which hurts recognition. If you control the capture, save at high quality; if you have a PNG original, use it via the Image to Text tool." },
      { question: "Can it read handwriting in a photo?", answer: "Not reliably. Tesseract is designed for printed text; cursive or informal handwriting usually produces garbled output." },
      { question: "Which languages are supported?", answer: "English, Portuguese, Spanish, French, German, Italian, Dutch, Polish, Turkish, Russian, Japanese, and Simplified Chinese. Pick the language that matches the text in the photo." },
    ...
    content: {
      ...
      howToUse: [
        ...
        "Wait while the OCR engine loads (first run only) and recognition runs.",
        "Review the extracted text, fix any mistakes, then copy it or download it as a .txt file.",
      ],
      useCases: [
    ...
    seo: {
      title: "JPG to Text - Free Browser OCR for Photos",
      description: "Extract text from JPG photos and images with OCR that runs entirely in your browser. No upload, no account required.",
    },
  },
  {
    slug: "png-to-text",
    ...
    layout: "intake",
    implemented: true,
    shortDescription: "Extract text from PNG images with in-browser OCR.",
    longDescription:
    ...
    appUrl: "/apps/png-to-text/",
    landingUrl: "/apps/png-to-text/",
    tags: ["png to text", "png ocr", "screenshot text", "ocr", "local", "privacy"],
    features: [
      "Runs entirely in your browser — the PNG is never uploaded to a server",
      "Lossless PNG sources give some of the most accurate OCR results",
      "Supports 12 recognition languages including English, Portuguese, and Spanish",
      "Editable result you can copy or download as .txt",
    ],
    faq: [
      { question: "Is PNG to Text free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my image?", answer: "No. OCR runs locally in the browser tab using WebAssembly. The PNG file is never sent to a server." },
      { question: "Why are PNGs good for OCR?", answer: "PNG compression is lossless, so letter edges stay sharp instead of being smoothed by compression artifacts — which helps the OCR engine recognize characters correctly." },
    ],
    faqExpanded: [
      { question: "Is PNG to Text free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my image?", answer: "No. Recognition is done by the Tesseract OCR engine compiled to WebAssembly, running inside your browser tab. Your image never leaves your device." },
      { question: "Why are PNGs good for OCR?", answer: "PNG compression is lossless, so text rendered into the image keeps crisp edges. Screenshots and exported graphics saved as PNG usually give noticeably better recognition than the same content saved as a compressed JPG." },
      { question: "Does it work on screenshots?", answer: "Yes — screenshots are a typical PNG source and usually recognize very well, since screen text is sharp and high-contrast. There is also a dedicated Screenshot to Text page with the same engine." },
      { question: "Does transparency in the PNG cause problems?", answer: "Transparent areas are treated as-is; if text sits on a transparent background it may end up on whatever default the render produces. For best results use a PNG with a solid, contrasting background." },
      { question: "Which languages are supported?", answer: "English, Portuguese, Spanish, French, German, Italian, Dutch, Polish, Turkish, Russian, Japanese, and Simplified Chinese. Pick the language that matches the text in the image." },
    ...
    seo: {
      title: "PNG to Text - Free Browser OCR Tool",
      description: "Extract text from PNG images with OCR that runs entirely in your browser. No upload, no account required.",
    },
  },
  {
    ...
    layout: "intake",
    implemented: true,
    shortDescription: "Copy the text out of any screenshot with in-browser OCR.",
    longDescription:
    ...
    appUrl: "/apps/screenshot-to-text/",
    landingUrl: "/apps/screenshot-to-text/",
    tags: ["screenshot to text", "copy text from screenshot", "ocr", "screen capture", "local", "privacy"],
    features: [
      "Paste a screenshot straight from your clipboard — no need to save a file first",
      "Runs entirely in your browser — the screenshot is never uploaded to a server",
      "Screen text recognizes very accurately thanks to sharp, high-contrast rendering",
      "Editable result you can copy or download as .txt, in 12 recognition languages",
    ],
    faq: [
      { question: "Is Screenshot to Text free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my screenshot?", answer: "No. OCR runs locally in the browser tab using WebAssembly. The screenshot is never sent to a server." },
      { question: "Can I paste directly from the clipboard?", answer: "Yes. Take a screenshot, click the drop zone, and press Ctrl/Cmd+V — no need to save it as a file first." },
    ],
    faqExpanded: [
      { question: "Is Screenshot to Text free to use?", answer: "Yes. The tool is free and runs directly in your browser with no account required." },
      { question: "Does this tool upload my screenshot?", answer: "No. Recognition is done by the Tesseract OCR engine compiled to WebAssembly, running inside your browser tab. The screenshot never leaves your device — which matters, since screenshots often contain private information." },
      { question: "Can I paste directly from the clipboard?", answer: "Yes. Capture with PrintScreen, Win+Shift+S, or Cmd+Shift+4, click the drop zone, and press Ctrl/Cmd+V. The image is recognized immediately without saving a file." },
      { question: "Why do screenshots recognize so well?", answer: "Screen text is rendered pixel-sharp with strong contrast and no photographic noise, which is close to ideal input for an OCR engine. Expect noticeably better results than from photos of paper." },
      { question: "Can I extract an error message from a screenshot?", answer: "Yes — that's one of the most common uses. Extract the exact error text so you can search for it or paste it into a bug report instead of retyping it." },
      { question: "What if the text in my screenshot is tiny?", answer: "Small UI text can drop accuracy. Zoom the source window before capturing, or crop the screenshot tight around the text, so the letters are larger relative to the image." },
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Convert times instantly between any two time zones. Handle daylight saving time, see current time across multiple cities, and plan meetings across regions — all without uploading data to any server.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Format and indent XML documents with custom indentation levels. Fix malformed XML, normalize whitespace, and validate structure. All processing happens locally in your browser — no data uploads.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Convert XML data into formatted JSON. Transform XML documents into JSON structure for easier processing and API integration.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Generate XML sitemaps from URLs or website crawling. Create sitemap files for search engine submission and crawl optimization.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Generate .htaccess redirect rules for Apache servers. Create 301 permanent and 302 temporary redirects visually.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Build a starter Content Security Policy (CSP) header with preset rules for common scenarios. Understand CSP directives, generate production-ready headers, and improve website security against injection attacks.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Generate .gitignore files from templates for popular frameworks and languages (Node.js, Python, React, .NET, Go). Copy-paste ready for your project with no manual configuration needed.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Generate .dockerignore rules to exclude unnecessary files from Docker images. Keep builds fast and images lean by specifying what Docker should ignore during COPY commands and build context.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Format SQL queries with readable line breaks and consistent indentation. Convert single-line SQL into clean, maintainable code — useful for query review, documentation, and collaboration.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Build campaign URLs with UTM tracking parameters for analytics. Add source, medium, campaign, content, and term parameters visually without URL encoding. Track marketing campaigns effectively.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Build complete URLs from key-value query parameters visually. Add, remove, or modify UTM tags, API parameters, and search filters without manual URL encoding. Export clean URLs ready to use.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Count word frequency in text and display results as a sorted list. Analyze text to find most common words and terms.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Generate JSON Schema from sample JSON data automatically. Create schema definitions for validation, documentation, and API contracts.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Extract specific values from JSON using JSONPath expressions. Query and filter JSON data with XPath-like syntax for powerful data extraction.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Convert CSV data into SQL INSERT statements. Specify table name and column mapping, handle data types, and generate ready-to-execute SQL — useful for bulk data import and database migrations.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Convert CSV data into a Markdown-formatted table instantly. Perfect for embedding data in GitHub READMEs, documentation, blogs, and technical writing.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Generate CSS clamp() functions for responsive sizing. Create fluid typography and spacing that scales between breakpoints.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Minify CSS code to reduce file size. Remove whitespace, comments, and unnecessary characters while preserving functionality.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Build Markdown tables visually from headers and rows. Auto-align columns, adjust separators, and copy the table markdown ready for GitHub, blogs, documentation, and technical content.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Validate UUID strings and check format correctness. Verify UUIDs from databases, APIs, and logs. Display UUID version and format information.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Generate sortable ULID (Universally Unique Lexicographically Sortable Identifiers) locally in your browser. Useful for databases, distributed systems, and applications needing sortable unique IDs without server calls or external dependencies.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Validate card-like numbers (credit cards, SSN, etc.) using the Luhn algorithm checksum. Detect invalid formats before processing — all validation runs locally in your browser without uploads.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Find common MIME types from file extensions instantly. Perfect for API development, file uploads, content-type headers, and working with different file formats and media types.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Validate and normalize email address syntax locally. Check format, detect common typos, and verify if an email passes basic RFC 5322 validation — all in your browser without server calls.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Format timestamp lines into clean YouTube chapter markup. Convert common timestamp formats into YouTube's required [HH:MM:SS] Chapter Name syntax for video descriptions and chapters.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Extract and categorize tags from YouTube video titles and descriptions. Find keywords and topics for YouTube SEO analysis.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Count characters in YouTube titles and check against YouTube limits. Ensure titles are optimal length for search and display.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Clean and format YouTube video descriptions. Remove extra whitespace, normalize line breaks, and structure description text.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Extract and deduplicate hashtags from Instagram captions. Clean up hashtag lists, remove duplicates, and prepare batches for cross-posting to other social platforms.",
  ...
  },
  {
    ...
    layoutWidth: "5xl",
    implemented: true,
    shortDescription: "Format Instagram captions with proper line breaks and spacing. Clean up text, adjust line length, and prepare captions for posting.",
...
const seoClusterApps: AppDefinition[] = [
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Compress images to exactly 200KB for various use cases. Supports PNG, JPG, WebP formats. Reduce file size while maintaining acceptable quality — all locally.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Compress JPG images to exactly 100KB while preserving quality. Reduce file size for web, email, and social media sharing. All processing stays local in your browser.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Compress PNG images to exactly 100KB without visible quality loss. Reduce file size for faster web loading, email sharing, and mobile optimization — all locally in your browser.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Compress WebP images to exactly 100KB for optimal web performance. Convert and compress modern image format without server uploads. All work done locally.",
  ...
  },
  {
    ...
    layout: "stack",
    implemented: true,
    shortDescription: "Compress PDF files to approximately 500KB size. Reduce file size for easier email sharing, storage, and web distribution — all processing happens locally.",
  ...
  },
  {
    ...
    layoutRail: 440,
    implemented: true,
    shortDescription: "Analyze and validate HTML meta tags on web pages. Check title, description, Open Graph, Twitter cards, and other metadata.",
