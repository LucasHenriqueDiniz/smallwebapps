...
import {
  ...
  DialogTitle,
  DialogTrigger,
} from "@/tools/tubetrace/native/components/ui/dialog";
import { Header } from "@/tools/tubetrace/native/components/Header";
...
import {
  ...
  parseHistoryFile,
} from "@/tools/tubetrace/native/lib/parser";
...
export function UploadSection() {
  ...
  useEffect(() => {
    if (typeof navigator !== "undefined") {
      setLocale(navigator.language.toLowerCase().startsWith("pt") ? "pt-BR" : "en");
    }
  }, []);
